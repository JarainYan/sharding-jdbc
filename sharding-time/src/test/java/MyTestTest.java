    ...
    public void testInsertOrder(){
        for (int i = 0 ; i<10; i++){
           ...
           orderDao.insertOrder(new BigDecimal((i+1)*5),1L,"WAIT_PAY",String.valueOf(i),
                   TimeUtil.stringToDate("2021-01-18 15:23:23",TimeUtil.WHOLE_TIME));
//           orderDao.insertOrder(new BigDecimal((i+1)*5),1L,"WAIT_PAY",String.valueOf(i), new Date());
            /**
             * 保存用户 手写sql
             */
...
//            orderDao.save(orderDo);
    ...
    public void testSelectOrderbyIds(){
         ...
         * 自定义sql查询
         */
        Date start = TimeUtil.stringToDate("2021-01-01 15:23:23", TimeUtil.WHOLE_TIME);
        Date end = TimeUtil.stringToDate("2021-01-02 15:23:23", TimeUtil.WHOLE_TIME);
//        List<OrderDo> maps = orderDao.selectOrderbyIds(start,end);
//        System.out.println("maps:"+maps.size()+maps.toString());
        /**
         * jpa查询  查询全部
         */
        List<OrderDo> all = orderDao.findAllByCreateTimeBetween(start,end);
